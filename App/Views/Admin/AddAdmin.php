<html>
<head>
	<title>Affiliox-AdminRegistration</title>
				...
				<div class="row  rowMargin">
					<div class="col12">
						<div>
							...
							<input type="text" name="position" placeholder="Head Admin" minlength="5" maxlength="100" pattern="[a-zA-Z0-9'-'\s]*" title="Invalid Admin Format." required><br>
						</div>
					</div>
				</div>
				<div class="row  rowMargin">

...
<head>
  <title>Affiliox-Registration Successfull</title>
    ...
    <div class="row margint50 sm-center ">
      <div class="col9 search label ">
        <div class="col12 ">
          ...
          <div class="col12">
            <h3>Your Request has been Submitted. Our Site-Admin will review your request and inform via Email. </h3><br><br>
            <h2>Please be in Touch , Thank you </h2>
        </div>
        ...
        <div class="row ">
          ...
          <div class="col12 ">
            <div class="center nav-bar margint50 marginb100">
              <ul>
              <a href="../login/index"><i class="fas fa-sign-in-alt"></i>&nbsp;Log in</a></ul>
            </div>
          </div>
        </div>

			...
			<div class="row rowMargin ">
				<div class="col12">
					<div>
						...
						<input type="text" id="store" name="store" placeholder="Your Store Name" minlength="5" maxlength="100" pattern="[a-zA-Z'-'\s]*" title="Remove unwanted characters." required><br>
					</div>
				</div>
			</div>
				<div class="row ">

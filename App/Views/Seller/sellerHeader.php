      ...
      <div class="col12 fullwidth">
        ...
        <!-- <div class=" ">
            ...
            <div class=" nav-barN centerN backcolorN">
                <div class="col1N open-btnN hidden-smN" onclick="openNav()">
                    &#9776;
                </div>
                ...
                <div class="col4N searchN fitcontentN centerN">
                    <ul>
                        <input type="text" name="search" placeholder="Headsets" />
                        <a href=""><i class="fas fa-search"></i></a>
                    </ul>
                ...
                <div class="col1N hidden-smN ">
                    <div class="selectorN margint20N">
                        ...
                        <select name="direction" id="select-navN" onchange="location = this.value;">
                            <?php if(isset($_SESSION['username']) and !empty($_SESSION['username'])){

...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="../../../public/css/promoter/market-place-css.css">
	...
	<!-------------- Top-Navigation-Bar ---------------------->
      ...
      <h2><i class="fab fa-shopify"></i>&nbsp; &nbsp;Welcome to Market Place</h2>
        ...
        <button type="search" name="submit">Search</button>
			...
			<div class="card">
  				<img src="../../../public/images/promoter/drone.jpg" alt="Drone">
			...
			<div class="card">
  				<img src="../../../public/images/promoter/action-camera.jpg" alt="Drone">
  				<div class="promote-button">
  					<form action="generate-link.php" name="" method="">
              <p>Price 99.9 USD</p>
  						<input id="promoter-button" type="submit" name="" value="Promote"></a>
			...
			<div class="card">
  				<img src="../../../public/images/promoter/i-phone.png" alt="Drone">
  				<div class="promote-button">
  				<form action="generate-link.php" name="" method="">
            <p>Price 99.9 USD</p>
  					<input id="promoter-button" type="submit" name="" value="Promote"></a>
			...
			<div class="card">
  				<img src="../../../public/images/promoter/watch.png" alt="Drone">
  				<div class="promote-button">
  				<form action="generate-link.php" name="" method="">
            <p>Price 99.9 USD</p>
  					<input id="promoter-button" type="submit" name="" value="Promote"></a>
			...
			<div class="card">
  				<img src="../../../public/images/promoter/dslr.jpg" alt="Drone">
  				<div class="promote-button">
  				  <form action="generate-link.php" name="" method="">
              <p>Price 99.9 USD</p>
  					 <input  id="promoter-button" type="submit" name="" value="Promote"></a>

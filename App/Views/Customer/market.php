                ...
                <div class="row hidden-xm  ">
                    <div class="center lm-half-width">
                        <div class="margint20  icon-flo search center">
                            <div class=" search fitcontent center" onclick="openNav2()"><i
                                    class="icon fas fa-filter"></i>
                            </div>
                        ...
                        <div class="col3">
                            <div class="">
                                <div class="col12 nav-bar center">
                                    <button onclick="location.href='../User/Product'">&nbsp;&nbsp; Buy Product &nbsp;&nbsp;</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="boxsummery shoppingBlock marginb20 margint20 center ">
                        ...
                        <div class="col6">
                            <div class="margint20 left">
                                ...
                                <p> Waterproof Action Camera with Front LCD and Touch Rear Screens, 5K Ultra HD
                                    Video,
                                    20MP Photos, 1080p Live Streaming, Webcam, Stabilization</p> <br><br>

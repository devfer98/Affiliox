...
<head>
	...
	<link rel="shortcut icon" href="promoter/images/affiliox.png" type="image/x-icon">
...
<body>
	...
	<header>
		<nav class="top-nav">
			<ul class="main-nav">
				<li class="logo"><a href="index.html" style="border: none;"><img src="promoter/images/affiliox.png"></a></li>
	...
	<div class="container">
		...
		<div class="featured">
			...
			<div class="card">
  				<img src="images/i pod.png" alt="Denim Jeans" style="width:100%">
  					<h4>i12 Pods</h4>
			...
			<div class="card">
  				<img src="images/action-camera.jpg" alt="Denim Jeans" style="width:100%">
  					<h4>Apple iPhone 11 Pro</h4>
  					<p class="price">$1311.02</p>
  					<p>Apple iPhone 11 Pro 64GB ROM - 4GB RAM - Green</p>
  					<p><button>Buy Now <i class="fab fa-cc-visa"></i></button><button>Add to Cart <i class="fas fa-shopping-cart"></i></button></p>
			...
			<div class="card">
  				<img src="images/drone.jpg" alt="Denim Jeans" style="width:100%">
  					<h4>Apple iPhone 11 Pro</h4>
  					<p class="price">$1311.02</p>
  					<p>Apple iPhone 11 Pro 64GB ROM - 4GB RAM - Green</p>
  					<p><button>Buy Now <i class="fab fa-cc-visa"></i></button><button>Add to Cart <i class="fas fa-shopping-cart"></i></button></p>
			...
			<div class="card">
  				<img src="images/dslr.jpg" alt="Denim Jeans" style="width:100%">
  					<h4>Apple iPhone 11 Pro</h4>
  					<p class="price">$1311.02</p>
  					<p>Apple iPhone 11 Pro 64GB ROM - 4GB RAM - Green</p>
  					<p><button>Buy Now <i class="fab fa-cc-visa"></i></button><button>Add to Cart <i class="fas fa-shopping-cart"></i></button></p>
